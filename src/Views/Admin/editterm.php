            ...
            <div class="span6 offset2">
                <form class="form-horizontal" action="<?= WEB_ROOT ?>admin/saveterm/<?= $term['id'] ?>" method="post">
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input class="input-block-level" type="text" name="term" value="<?= $term['term'] ?>"
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <textarea class="input-block-level" rows="6" name="meaning"
                                      placeholder="Reikšmė"><?= $term['meaning'] ?></textarea>
                        </div>
                    </div>
